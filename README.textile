...
The Promotion is used to modify the RatePlan which provides information on who, when, pricing modifications and code used in creating and modifying a Purchase.
